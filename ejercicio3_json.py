...
def main():
    ...
    while True:
        ...
        if dato == 's' or dato == "S":
            ...
            print("Ingrese el nombre del estudiante (o escriba 'fin' para terminar): ")
            campo_nombre = input()
            if campo_nombre == 'fin':
                break
            else:
                ...
                estudiante = {'Nombre': campo_nombre, 'Apellido Paterno': campo_apellidoP, 'Apellido Materno': campo_apellidoM, 'No. de Control': campo_noControl, 'CURP': campo_CURP, 'Correo electrónico': campo_correo}
